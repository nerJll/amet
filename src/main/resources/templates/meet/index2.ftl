...
<div class="easyui-layout" style="width: 100%; height: 680px;">
	...
	<div data-options="region:'center',title:'会议预订	',iconCls:'icon-tip'">
		...
		<div style="width:100%;height:95%;">
				...
				<div style="width:39%;height:100%;float:left">
					<div style="width: 100%; height: 35px; border: 1px solid #F7F7F7;
						border-radius:5px;
			 			...
			 			<tr>
			 				<td>
			 					<div id="aiko_1" style="width:150px;height:105px;background-color:#FFC125;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
				...
				<div style="width:59%;height:100%;float:right">
					<div style="width: 100%; height: 35px; border: 1px solid #F7F7F7;
						border-radius:5px;	
			 			background-color: #FFFFF0; margin:3px 0 0 0">
			 			<table style="width:100%;text-align:center;font-size:20px">
			 			<tr><td colspan="4">浙江爱旭会议室</td></tr>
			 			<tr style="height:5px"></tr>
			 			<!-- 一排 -->
			 			<tr>
			 				<td>
			 					<div id="aixu_1" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>1#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_1a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_1')" 
														>详情</a>
													</div>
													<div id="aixu_1c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_1')" 
														>选中</a>
													</div>
													 <div id="aixu_1d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_1')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_2" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 					<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 								<td colspan="3">
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_2a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_2')" 
														></a>
													</div>
													<div id="aixu_2c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_2')" 
														></a>
													</div>
													 <div id="aixu_2d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_2')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_3" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 							</tr>
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_3a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_3')" 
														></a>
													</div>
													<div id="aixu_3c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_3')" 
														></a>
													</div>
													 <div id="aixu_3d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_3')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_4" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>4#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_4a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_4')" 
														>详情</a>
													</div>
													<div id="aixu_4c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_4')" 
														>选中</a>
													</div>
													 <div id="aixu_4d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_4')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 			...
			 			<tr>
			 				<td>
			 					<div id="aixu_5" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>5#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_5a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_5')" 
														>详情</a>
													</div>
													<div id="aixu_5c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_5')" 
														>选中</a>
													</div>
													 <div id="aixu_5d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_5')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_6" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 					<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 								<td colspan="3">
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_6a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_6')" 
														></a>
													</div>
													<div id="aixu_6c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_6')" 
														></a>
													</div>
													 <div id="aixu_6d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_6')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_7" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 							</tr>
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_7a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_7')" 
														></a>
													</div>
													<div id="aixu_7c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_7')" 
														></a>
													</div>
													 <div id="aixu_7d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_7')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_8" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>8#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_8a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_8')" 
														>详情</a>
													</div>
													<div id="aixu_8c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_8')" 
														>选中</a>
													</div>
													 <div id="aixu_8d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_8')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 			...
			 			<tr>
			 				<td>
			 					<div id="aixu_9" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>9#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_9a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_9')" 
														>详情</a>
													</div>
													<div id="aixu_9c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_9')" 
														>选中</a>
													</div>
													 <div id="aixu_9d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_9')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_10" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 					<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 								<td colspan="3">
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_10a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_10')" 
														></a>
													</div>
													<div id="aixu_10c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_10')" 
														></a>
													</div>
													 <div id="aixu_10d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_10')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_11" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 							</tr>
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_11a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_11')" 
														></a>
													</div>
													<div id="aixu_11c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_11')" 
														></a>
													</div>
													 <div id="aixu_11d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_11')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_12" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>12#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_12a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_12')" 
														>详情</a>
													</div>
													<div id="aixu_12c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_12')" 
														>选中</a>
													</div>
													 <div id="aixu_12d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_12')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 			...
			 			<tr>
			 				<td>
			 					<div id="aixu_13" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>13#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_13a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_13')" 
														>详情</a>
													</div>
													<div id="aixu_13c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_13')" 
														>选中</a>
													</div>
													 <div id="aixu_13d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_13')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_14" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 					<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 								<td colspan="3">
			 							...
			 							<tr>
			 								<td>
			 									<div id="aixu_14a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_14')" 
														></a>
													</div>
													<div id="aixu_14c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_14')" 
														></a>
													</div>
													 <div id="aixu_14d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_14')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_15" style="width:120px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:25px">
			 							</tr>
			 							<tr><td colspan="3"><b>15#</b></td></tr>
			 							<tr style="height:5px">
			 							<tr>
			 								<td>
			 									<div id="aixu_15a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 40px; height: 30px" onclick="getRoomInfo('aixu_15')" 
														></a>
													</div>
													<div id="aixu_15c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 40px; height: 30px" onclick="checkDiv('aixu_15')" 
														></a>
													</div>
													 <div id="aixu_15d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('aixu_15')" 
														>取消</a>
													 </div> 
												</div>
			 								</td>
			 				...
			 				<td>
			 					<div id="aixu_16" style="width:150px;height:105px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:30px">
			 							</tr>
			 							<tr><td colspan="4"><b>16#</b></td></tr>
			 							<tr>
			 								<td>
			 									<div id="aixu_16a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-search'"
														style="width: 60px; height: 30px" onclick="getRoomInfo('aixu_16')" 
														>详情</a>
													</div>
													<div id="aixu_16c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														data-options="iconCls:'icon-ok'"
														style="width: 60px; height: 30px" onclick="checkDiv('aixu_16')" 
														>选中</a>
													</div>
													 <div id="aixu_16d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 60px; height: 30px" onclick="RemoveCk('aixu_16')" 
														>取消选中</a>
													 </div> 
												</div>
			 								</td>
			...
			<!-- 右 -->
			<div style="width:14%;height:100%;text-align:center;float:right">
				<div style="width: 100%; height: 35px; border: 1px solid #F7F7F7;
						border-radius:5px;
			 			background-color: #FFFFF0; margin:3px 0 0 0">
			 		<table style="width:100%;text-align:center;font-size:20px">
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_1" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="align:center;width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							<tr>
			 							<td>
			 								<div id="dk_1a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_1')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>001</b></td>
			 							<td>
			 								<div id="dk_1e">
			 										<div id="dk_1c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_1')" 
														>选中</a>
													</div>
													 <div id="dk_1d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_1')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_2" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_2a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_2')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>002</b></td>
			 							<td>
			 								<div id="dk_2e">
			 										<div id="dk_2c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_2')" 
														>选中</a>
													</div>
													 <div id="dk_2d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_2')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_3" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_3a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_3')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>003</b></td>
			 							<td>
			 								<div id="dk_3e">
			 										<div id="dk_3c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_3')" 
														>选中</a>
													</div>
													 <div id="dk_3d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_3')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_4" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_4a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_4')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>004</b></td>
			 							<td>
			 								<div id="dk_4e">
			 										<div id="dk_4c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_4')" 
														>选中</a>
													</div>
													 <div id="dk_4d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_4')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_5" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_5a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_5')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>005</b></td>
			 							<td>
			 								<div id="dk_5e">
			 										<div id="dk_5c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_5')" 
														>选中</a>
													</div>
													 <div id="dk_5d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_5')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_6" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_6a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_6')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>006</b></td>
			 							<td>
			 								<div id="dk_6e">
			 										<div id="dk_6c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_6')" 
														>选中</a>
													</div>
													 <div id="dk_6d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_6')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_7" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_7a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_7')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>007</b></td>
			 							<td>
			 								<div id="dk_7e">
			 										<div id="dk_7c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_7')" 
														>选中</a>
													</div>
													 <div id="dk_7d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_7')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
			 		...
			 		<tr>
			 			<td>
			 					<div id="dk_8" style="width:150px;height:50px;background-color:#9AFF9A;
			 					border-radius:8px;">
			 						<table style="width:100%;text-align:center;font-size:20px">
			 							<tr style="height:10px">
			 							</tr>
			 							...
			 							<td>
			 								<div id="dk_8a">
				 									...
				 									<a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="getRoomInfo('dk_8')" 
														>详情</a>
													</div>
										</div>
			 							<td><b>008</b></td>
			 							<td>
			 								<div id="dk_8e">
			 										<div id="dk_8c" style="float:right">
				 									 <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="checkDiv('dk_8')" 
														>选中</a>
													</div>
													 <div id="dk_8d" style="float:right">
													  <a href="javascript:void(0)" class="easyui-linkbutton"
														style="width: 40px; height: 30px" onclick="RemoveCk('dk_8')" 
														>取消</a>
													 </div> 
											</div>
			 							</td>
