...
var axNoAudioMeetRoom=new Array("aixu_2","aixu_5","aixu_6","aixu_7","aixu_8","aixu_11","aixu_12","aixu_14","aixu_15")
var romi = ''
var dkmi = ''
	...
	function showC(){
		for (var i = 1; i < 13; i++) {
			$("#aiko_" + i).css("background-color", "#FFE4B5")
			$("#aiko_" + i + "c").show()
		}
		for (var i = 1; i < 17; i++) {
			$("#aixu_" + i).css("background-color", "#FFE1FF")
			$("#aixu_" + i + "c").show()
		}
		for (var i = 1; i < 11; i++) {
			$("#dk_" + i).css("background-color", "#E6E6FA")
			$("#dk_" + i + "c").show()
		}
	}
		...
		if(romi!=''||dkmi!=''){
			...
			if(am=="视频会议"){
				for(var i=0; i<akNoAudioMeetRoom.length; i++){
					$("#"+akNoAudioMeetRoom[i]).css("background-color", "red")
					$("#"+akNoAudioMeetRoom[i]+"c").hide()
				}
				for(var i=0; i<axNoAudioMeetRoom.length; i++){
					$("#"+axNoAudioMeetRoom[i]).css("background-color", "red")
					$("#"+axNoAudioMeetRoom[i]+"c").hide()
				}
			}else{
				for(var i=0; i<akNoAudioMeetRoom.length; i++){
					$("#"+akNoAudioMeetRoom[i]).css("background-color", "#FFE4B5")
				}
				for(var i=0; i<axNoAudioMeetRoom.length; i++){
					$("#"+axNoAudioMeetRoom[i]).css("background-color", "#FFE1FF")
				}
				for(var i=0; i<11; i++){
					$("#dk_"+i).css("background-color", "red")
					$("#dk_" + i + "c").hide()
				}
			}
			...
			$.ajax({
				...
				success:function(data){
					for(var i=0; i<data.length; i++){
						$("#"+data[i].meetRoomId).css("background-color", "red")
				...
				<table>
					<tr>
						...
						<td><input style="width: 17px; height: 17px" type="radio"
							id="audiomeet" name="audiomeet" checked value="视频会议"> <span
						...
						<div
							...
							<table style="width: 100%; text-align: center; font-size: 20px">
								...
								<tr>
									<td colspan="2">
										<div id="aiko_1"
											style="width: 250px; height: 100px; background-color: #FFE4B5; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 20px">
												<tr style="height: 20px">
													<td colspan="2"><img alt="视频会议"
														src="${ctx}/images/camera4.png" width=20px height=20px>
													</td>
												</tr>
												<tr>
									...
									<td>
										<div id="aiko_2"
											style="width: 170px; height: 100px; background-color: #FFE4B5; border-radius: 8px;">
											<table
								...
								<tr>
									<td>
										<div id="aiko_5"
											style="width: 120px; height: 100px; background-color: #FFE4B5; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 30px">
												<tr>
													...
													<td>
														<div id="aixu_2a">
															<div id="aixu_2b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 80px; height: 45px" id='queroom14'
																	onclick="getRoomInfo('aixu_2')"></a>
															</div>
															<div id="aixu_2c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 80px; height: 45px" id='selectroom14'
														...
														<div id="aixu_2d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 80px; height: 45px" id='disecroom14'
					...
					<div
						...
						<table style="width: 100%; text-align: center; font-size: 20px">
							...
							<tr>
								<td>
									<div id="dk_1"
										style="width: 180px; height: 48px; background-color: #E6E6FA; border-radius: 8px;">
										<table
